...
const QuizCreateContext = createContext<IQuizCreate | null>(null);

export const QuizCreateWrapper = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <QuizCreateContext.Provider value={{
            createQuestions,
            setCreateQuestions,
            selectQuestions,
            setSelectQuestions,
