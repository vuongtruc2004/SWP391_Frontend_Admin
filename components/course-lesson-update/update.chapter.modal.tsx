...
const UpdateChapterModal = ({ chapters, selectedChapter, setSelectedChapter, open, setOpen, course }: {
                        ...
                        { required: true, message: 'Vui lòng không để trống tiêu đề!' },
                        {
                            validator(_, value) {
                                if (value) {
                                    ...
                                    if (chapters.find(chapter => chapter.title.toLowerCase().trim() === value.toLowerCase().trim() && chapter.chapterId !== selectedChapter.chapterId)) {
