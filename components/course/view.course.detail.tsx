        ...
        <>
            <Drawer title="THÔNG TIN CHI TIẾT" onClose={onClose} open={openDraw}>
                {course ? <>
                    ...
                    <div className='mb-2'><span className='text-blue-500 text-base mr-2 font-bold'>Giá gốc: </span>{course.price.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</div>
