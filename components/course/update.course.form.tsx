...
const UpdateCourseForm = (props: {
    ...
    const [linkIntro, setLinkIntro] = useState(editingCourse?.introduction);
    const [originalPrice, setOriginalPrice] = useState<number>(editingCourse?.originalPrice || 0);
    const [salePrice, setSalePrice] = useState<number>(editingCourse?.salePrice || 0);
    ...
    return (
        <div>
            ...
            >
                <h1 className="text-center text-2xl font-semibold">Cập nhật khoá học</h1>
